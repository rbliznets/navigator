		...
		struct platform_device *pdev, char *panel_cfg)
{
	...
	struct mdss_panel_info *pinfo = &ctrl_pdata->panel_data.panel_info;
	char panel_cfg_cmdline[] = "0:qcom,mdss_dsi_extern_bridge_720p_video:config0:1:none:cfg:single_dsi";
//	char panel_cfg_cmdline[] = "0:qcom,mdss_dsi_extern_bridge_1280p_video:config0:1:none:cfg:single_dsi";
