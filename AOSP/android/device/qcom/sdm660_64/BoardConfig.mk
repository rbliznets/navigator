...
ifeq ($(ENABLE_VENDOR_IMAGE), true)
  ifeq ($(strip $(BOARD_DYNAMIC_PARTITION_ENABLE)),true)
    AB_OTA_PARTITIONS ?= boot dtbo system vendor product vbmeta_system vbmeta 
  else
    AB_OTA_PARTITIONS ?= boot dtbo system vendor product vbmeta_system vbmeta 
  endif
else
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 6115941120
...
BOARD_SEPOLICY_DIRS := device/qcom/sdm660/sepolicy/vendor/sdm660
#################################################################################
