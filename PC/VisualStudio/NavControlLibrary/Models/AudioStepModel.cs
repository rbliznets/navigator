...
{
    public class AudioStepModel : NotifyModel
    {
        public delegate void eChangeGPS(AudioStepModel script);
        ...
        public AudioStepModel(JToken json, string path, DIR_TYPES? route)
        {
        ...
        public AudioStepModel(DIR_TYPES? route)
        {
            if (route != null)
            {
                Route = (DIR_TYPES)route;
        ...
        public AudioStepModel(AudioStepModel step)
        {
            Route = step.Route;
            mStop = step.mStop;
            GPS = step.GPS;
