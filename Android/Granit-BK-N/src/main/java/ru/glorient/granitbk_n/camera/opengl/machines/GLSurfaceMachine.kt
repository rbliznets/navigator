...
import ru.glorient.granitbk_n.camera.opengl.machines.GLSurfaceAction.*
import ru.glorient.granitbk_n.camera.opengl.machines.GLSurfaceState.*
import ru.glorient.granitbk_n.camera.opengl.utils.SimpleProducer
import javax.microedition.khronos.egl.EGLConfig
import javax.microedition.khronos.opengles.GL10

class GLSurfaceMachine(val id: Int) : StateMachine<GLSurfaceState, GLSurfaceAction> {
    ...
    override fun transition(action: GLSurfaceAction, id: Int) {
...
//        val drawable = state.uiHolder.textView
...
//            val bounds = drawable.clipBounds
