package ru.glorient.granitbk_n.video
...
import ru.glorient.granitbk_n.databinding.ActivityVideoFullscreenBinding
import java.io.File
                ...
                try {
                    ...
                    if (msg.has("video")) {
                        ...
                        if(vid != 0L){
                            ...
                            LocalBroadcastManager.getInstance(this@VideoFullscreenActivity).sendBroadcast(intent)
                            vid = 0
                        }
